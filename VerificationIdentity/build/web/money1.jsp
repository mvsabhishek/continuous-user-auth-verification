        ...
        <div id="main">		
            ...
            <div id="site_content" style="height: 380px;"><br /><br /><br />
                ...
                <div style="margin-top: 50px;color: white">
                    <center>
                        <a href="ownaccount.jsp" style="text-decoration: none">
                            <img src="images/bank3.png" width="100" height="100" />
                            <button class="myButton">Own Account</button>
                        </a>
                        
                        <a href="intratransaction.jsp" style="text-decoration: none">
                            <img src="images/bank7.png" width="100" height="100" />
                            <button class="myButton">Intra Account</button>
                        </a>
                         <a href="intertransaction.jsp" style="text-decoration: none">
                            <img src="images/bank7.png" width="100" height="100" />
                            <button class="myButton">Inter Account</button>
                        </a>
                    </center>
