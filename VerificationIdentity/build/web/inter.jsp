        ...
        <div id="main">		
            ...
            <div id="site_content" style="height: 380px;"><br /><br /><br />
                ...
                <%
                    ...
                    String bname = null;
                    String email = session.getAttribute("email").toString();
                    System.out.println("The Session Email is in inter "+email);
                    try {
                        con = Database.getConnection();
                        st = con.createStatement();
                        rs = st.executeQuery("select bname from reg where email='" + email + "'");
                        if (rs.next()) {
                ...
                <div style="margin-top: 50px;color: white">
                    ...
                    <form style="margin-top: 10px;width: 500px;height:200px;margin-left: 300px;" action="beneficialaction.jsp" method="post"> 
                        ...
                        <input type="hidden" value="1" name="bstatus" />
                    ...
                    <meta http-equiv="refresh" content="30;url=./index.html">ss
                </div>
